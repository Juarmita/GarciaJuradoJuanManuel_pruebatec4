...
public class Room implements Serializable {
    ...
    @JsonBackReference(value = "hotel-room")//Se usa para evitar la recursividad en la respuesta de la API. It is used to avoid recursion in the API response.
    ...
    @JsonManagedReference(value = "room-reservation")//Se define el nombre de la referencia. The name of the reference is defined.
